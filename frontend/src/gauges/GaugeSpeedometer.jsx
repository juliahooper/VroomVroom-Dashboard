...
export default function GaugeSpeedometer({
  ...
  return (
    <div className="boat-gauge boat-gauge-speed boat-gauge--classic">
      <div className="boat-gauge__face boat-gauge__face--dark">
        <div className="boat-gauge__dial">
          <svg viewBox="0 0 100 100" className="boat-gauge__svg" aria-hidden>
            <defs>
              <linearGradient id="speed-face-shine" x1="0%" y1="0%" x2="100%" y2="100%">
            ...
            <circle cx={cx} cy={cy} r={r} fill="url(#speed-face-shine)" />
            <g clipPath="url(#clip-speed)">
          ...
          <text x={cx} y={cy - 6} textAnchor="middle" className="boat-gauge__center-label" fill="rgba(255,255,255,0.85)">SPEED</text>
        ...
        <div className="boat-gauge__value boat-gauge__value--dark">{value.toFixed(1)}</div>
      </div>
    </div>
  )
}
